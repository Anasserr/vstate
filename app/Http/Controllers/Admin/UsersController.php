...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->rawColumns(['actions', 'placeholder', 'approved', 'verified', 'roles', 'image', 'active']);
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'userEventjoiningusers', 'createdByEvents', 'userProjects', 'userRealEstateUnits', 'userBookMeetings', 'userLikes', 'userUnitComments', 'userRealEstateApplications', 'userUserAlerts');
