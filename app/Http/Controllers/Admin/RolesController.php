    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('show_in_website', function ($row) {
                return '<input type="checkbox" disabled ' . ($row->show_in_website ? 'checked' : null) . '>';
            });
            $table->editColumn('active', function ($row) {
                return $row->active ? Role::ACTIVE_RADIO[$row->active] : '';
            });

            $table->rawColumns(['actions', 'placeholder', 'permissions', 'show_in_website']);
