...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-cityRegions">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.region.fields.city') }}
                        </th>
                        <th>
                            {{ trans('cruds.region.fields.title_ar') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-cityRegions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
