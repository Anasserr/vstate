    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('head_title') ? 'is-invalid' : '' }}" type="text" name="head_title" id="head_title" value="{{ old('head_title', $slider->head_title) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_title') ? 'is-invalid' : '' }}" type="text" name="link_title" id="link_title" value="{{ old('link_title', $slider->link_title) }}">
