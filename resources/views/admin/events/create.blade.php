    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('event_date') ? 'is-invalid' : '' }}" type="text" name="event_date" id="event_date" value="{{ old('event_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location_link') ? 'is-invalid' : '' }}" type="text" name="location_link" id="location_link" value="{{ old('location_link', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::PUBLISHED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="published_{{ $key }}" name="published" value="{{ $key }}" {{ old('published', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('event_tags') ? 'is-invalid' : '' }}" name="event_tags[]" id="event_tags" multiple>
                    @foreach($event_tags as $id => $event_tag)
                        <option value="{{ $id }}" {{ in_array($id, old('event_tags', [])) ? 'selected' : '' }}>{{ $event_tag }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show_first') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show_first" id="show_first" value="1" {{ old('show_first', 0) == 1 ? 'checked' : '' }}>
