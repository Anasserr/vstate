    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('event_date') ? 'is-invalid' : '' }}" type="text" name="event_date" id="event_date" value="{{ old('event_date', $event->event_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('addresse') ? 'is-invalid' : '' }}" type="text" name="addresse" id="addresse" value="{{ old('addresse', $event->addresse) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location_link') ? 'is-invalid' : '' }}" type="text" name="location_link" id="location_link" value="{{ old('location_link', $event->location_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="text" name="lat" id="lat" value="{{ old('lat', $event->lat) }}">
                @if($errors->has('lat'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lat') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lang') ? 'is-invalid' : '' }}" type="text" name="lang" id="lang" value="{{ old('lang', $event->lang) }}">
                @if($errors->has('lang'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lang') }}
                    </div>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::PUBLISHED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="published_{{ $key }}" name="published" value="{{ $key }}" {{ old('published', $event->published) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('event_tags') ? 'is-invalid' : '' }}" name="event_tags[]" id="event_tags" multiple>
                    @foreach($event_tags as $id => $event_tag)
                        <option value="{{ $id }}" {{ (in_array($id, old('event_tags', [])) || $event->event_tags->contains($id)) ? 'selected' : '' }}>{{ $event_tag }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show_first') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show_first" id="show_first" value="1" {{ $event->show_first || old('show_first', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="show_first">{{ trans('cruds.event.fields.show_first') }}</label>
                </div>
