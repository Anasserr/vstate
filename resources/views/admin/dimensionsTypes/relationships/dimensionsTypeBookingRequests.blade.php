...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table
                class=" table table-bordered table-striped table-hover datatable datatable-dimensionsTypeBookingRequests">
                <thead>
                    <tr>
                        <th width="10">
                            ...
                            <td>
                                @can('booking_request_show')
                                    <a class="btn btn-xs btn-primary"
                                        href="{{ route('admin.booking-requests.show', $bookingRequest->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('booking_request_edit')
                                    <a class="btn btn-xs btn-info"
                                        href="{{ route('admin.booking-requests.edit', $bookingRequest->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
                                ...
                                @can('booking_request_delete')
                                    <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework"
                                        action="{{ route('admin.booking-requests.destroy', $bookingRequest->id) }}"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-dimensionsTypeBookingRequests:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
