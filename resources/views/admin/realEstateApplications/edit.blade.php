    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                action="{{ route('admin.real-estate-applications.update', [$realEstateApplication->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('addresse') ? 'is-invalid' : '' }}" type="text"
                        name="addresse" id="addresse" value="{{ old('addresse', $realEstateApplication->addresse) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text"
                        name="location" id="location" value="{{ old('location', $realEstateApplication->location) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('max_price') ? 'is-invalid' : '' }}" type="number"
                        name="max_price" id="max_price" value="{{ old('max_price', $realEstateApplication->max_price) }}"
                        step="0.01">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('min_price') ? 'is-invalid' : '' }}" type="number"
                        name="min_price" id="min_price" value="{{ old('min_price', $realEstateApplication->min_price) }}"
                        step="0.01">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('deliver_year') ? 'is-invalid' : '' }}" type="text"
                        name="deliver_year" id="deliver_year"
                        value="{{ old('deliver_year', $realEstateApplication->deliver_year) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('number_of_rooms') ? 'is-invalid' : '' }}" type="text"
                        name="number_of_rooms" id="number_of_rooms"
                        value="{{ old('number_of_rooms', $realEstateApplication->number_of_rooms) }}">
                    ...
                    @endif
                    <span
                        class="help-block">{{ trans('cruds.realEstateApplication.fields.number_of_rooms_helper') }}</span>
                </div>
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('floor') ? 'is-invalid' : '' }}" type="text"
                        name="floor" id="floor" value="{{ old('floor', $realEstateApplication->floor) }}">
                    @if ($errors->has('floor'))
                        <div class="invalid-feedback">
                            {{ $errors->first('floor') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('user_name') ? 'is-invalid' : '' }}" type="text"
                        name="user_name" id="user_name" value="{{ old('user_name', $realEstateApplication->user_name) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('user_phone') ? 'is-invalid' : '' }}" type="text"
                        name="user_phone" id="user_phone"
                        value="{{ old('user_phone', $realEstateApplication->user_phone) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('time_of_call') ? 'is-invalid' : '' }}" type="text"
                        name="time_of_call" id="time_of_call"
                        value="{{ old('time_of_call', $realEstateApplication->time_of_call) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text"
                        name="email" id="email" value="{{ old('email', $realEstateApplication->email) }}">
                    @if ($errors->has('email'))
                        <div class="invalid-feedback">
                            {{ $errors->first('email') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id"
                        ...
                        @foreach ($users as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('user_id') ? old('user_id') : $realEstateApplication->user->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
                    @if ($errors->has('user'))
                ...
                <div class="form-group">
                    <label
                        for="listings_available_for_mortgages">{{ trans('cruds.realEstateApplication.fields.listings_available_for_mortgage') }}</label>
                    ...
                    <select
                        class="form-control select2 {{ $errors->has('listings_available_for_mortgages') ? 'is-invalid' : '' }}"
                        name="listings_available_for_mortgages[]" id="listings_available_for_mortgages" multiple>
                        @foreach ($listings_available_for_mortgages as $id => $listings_available_for_mortgage)
                            <option value="{{ $id }}"
                                {{ in_array($id, old('listings_available_for_mortgages', [])) || $realEstateApplication->listings_available_for_mortgages->contains($id) ? 'selected' : '' }}>
                                {{ $listings_available_for_mortgage }}</option>
                        @endforeach
                    </select>
                    ...
                    @endif
                    <span
                        class="help-block">{{ trans('cruds.realEstateApplication.fields.listings_available_for_mortgage_helper') }}</span>
                </div>
                <div class="form-group">
                    <label>{{ trans('cruds.realEstateApplication.fields.purpose_of_request') }}</label>
                    <select class="form-control {{ $errors->has('purpose_of_request') ? 'is-invalid' : '' }}"
                        name="purpose_of_request" id="purpose_of_request">
                        <option value disabled {{ old('purpose_of_request', null) === null ? 'selected' : '' }}>
                            {{ trans('global.pleaseSelect') }}</option>
                        @foreach (App\Models\RealEstateApplication::PURPOSE_OF_REQUEST_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('purpose_of_request', $realEstateApplication->purpose_of_request) === (string) $key ? 'selected' : '' }}>
                                {{ $label }}</option>
                        @endforeach
                    </select>
                    ...
                    @endif
                    <span
                        class="help-block">{{ trans('cruds.realEstateApplication.fields.purpose_of_request_helper') }}</span>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('payment_methods') ? 'is-invalid' : '' }}"
                        name="payment_methods[]" id="payment_methods" multiple>
                        @foreach ($payment_methods as $id => $payment_method)
                            <option value="{{ $id }}"
                                {{ in_array($id, old('payment_methods', [])) || $realEstateApplication->payment_methods->contains($id) ? 'selected' : '' }}>
                    ...
                    @endif
                    <span
                        class="help-block">{{ trans('cruds.realEstateApplication.fields.payment_method_helper') }}</span>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('types') ? 'is-invalid' : '' }}" name="types[]"
                        ...
                        @foreach ($types as $id => $type)
                            <option value="{{ $id }}"
                                {{ in_array($id, old('types', [])) || $realEstateApplication->types->contains($id) ? 'selected' : '' }}>
                                {{ $type }}</option>
                        @endforeach
                    </select>
                    @if ($errors->has('types'))
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('views') ? 'is-invalid' : '' }}" name="views[]"
                        id="views" multiple>
                        @foreach ($views as $id => $view)
                            <option value="{{ $id }}"
                                {{ in_array($id, old('views', [])) || $realEstateApplication->views->contains($id) ? 'selected' : '' }}>
                                {{ $view }}</option>
                        @endforeach
                    </select>
                    @if ($errors->has('views'))
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('finish_types') ? 'is-invalid' : '' }}"
                        name="finish_types[]" id="finish_types" multiple>
                        @foreach ($finish_types as $id => $finish_type)
                            <option value="{{ $id }}"
                                {{ in_array($id, old('finish_types', [])) || $realEstateApplication->finish_types->contains($id) ? 'selected' : '' }}>
                                {{ $finish_type }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('min_area') ? 'is-invalid' : '' }}" type="text"
                        name="min_area" id="min_area" value="{{ old('min_area', $realEstateApplication->min_area) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('max_area') ? 'is-invalid' : '' }}" type="text"
                        name="max_area" id="max_area" value="{{ old('max_area', $realEstateApplication->max_area) }}">
