...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.realEstateUnit.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.real-estate-units.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\RealEstateUnit::PREMIUM_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('premium') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="premium_{{ $key }}" name="premium" value="{{ $key }}" {{ old('premium', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_room') ? 'is-invalid' : '' }}" type="text" name="number_of_room" id="number_of_room" value="{{ old('number_of_room', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_floor') ? 'is-invalid' : '' }}" type="text" name="number_of_floor" id="number_of_floor" value="{{ old('number_of_floor', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_bath_room') ? 'is-invalid' : '' }}" type="text" name="number_of_bath_room" id="number_of_bath_room" value="{{ old('number_of_bath_room', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_master_room') ? 'is-invalid' : '' }}" type="text" name="number_of_master_room" id="number_of_master_room" value="{{ old('number_of_master_room', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('has_garage') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="has_garage" id="has_garage" value="1" {{ old('has_garage', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_garage') ? 'is-invalid' : '' }}" type="text" name="number_of_garage" id="number_of_garage" value="{{ old('number_of_garage', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nears') ? 'is-invalid' : '' }}" name="nears[]" id="nears" multiple>
                    @foreach($nears as $id => $near)
                        <option value="{{ $id }}" {{ in_array($id, old('nears', [])) ? 'selected' : '' }}>{{ $near }}</option>
                    @endforeach
                </select>
                @if($errors->has('nears'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bua') ? 'is-invalid' : '' }}" type="text" name="bua" id="bua" value="{{ old('bua', '') }}">
                @if($errors->has('bua'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bua') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ror') ? 'is-invalid' : '' }}" type="text" name="ror" id="ror" value="{{ old('ror', '') }}">
                @if($errors->has('ror'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ror') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('roi') ? 'is-invalid' : '' }}" type="text" name="roi" id="roi" value="{{ old('roi', '') }}">
                @if($errors->has('roi'))
                    <div class="invalid-feedback">
                        {{ $errors->first('roi') }}
                    </div>
