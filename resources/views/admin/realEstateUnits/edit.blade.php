...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.real-estate-units.update", [$realEstateUnit->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.realEstateUnit.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $realEstateUnit->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $realEstateUnit->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\RealEstateUnit::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $realEstateUnit->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="text" name="price" id="price" value="{{ old('price', $realEstateUnit->price) }}">
                @if($errors->has('price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('price') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project') ? 'is-invalid' : '' }}" name="project_id" id="project_id">
                    @foreach($projects as $id => $entry)
                        <option value="{{ $id }}" {{ (old('project_id') ? old('project_id') : $realEstateUnit->project->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('image_360') ? 'is-invalid' : '' }}" id="image_360-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id" required>
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $realEstateUnit->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\RealEstateUnit::FEATURED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="featured_{{ $key }}" name="featured" value="{{ $key }}" {{ old('featured', $realEstateUnit->featured) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\RealEstateUnit::PREMIUM_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('premium') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="premium_{{ $key }}" name="premium" value="{{ $key }}" {{ old('premium', $realEstateUnit->premium) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('images_360') ? 'is-invalid' : '' }}" id="images_360-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('location_link') ? 'is-invalid' : '' }}" name="location_link" id="location_link">{{ old('location_link', $realEstateUnit->location_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="text" name="lat" id="lat" value="{{ old('lat', $realEstateUnit->lat) }}">
                @if($errors->has('lat'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lat') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lang') ? 'is-invalid' : '' }}" type="text" name="lang" id="lang" value="{{ old('lang', $realEstateUnit->lang) }}">
                @if($errors->has('lang'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lang') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_room') ? 'is-invalid' : '' }}" type="text" name="number_of_room" id="number_of_room" value="{{ old('number_of_room', $realEstateUnit->number_of_room) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_floor') ? 'is-invalid' : '' }}" type="text" name="number_of_floor" id="number_of_floor" value="{{ old('number_of_floor', $realEstateUnit->number_of_floor) }}">
            ...
            <div class="form-group">
                <label for="number_of_bath_room">{{ trans('cruds.realEstateUnit.fields.number_of_bath_room') }}</label>
                <input class="form-control {{ $errors->has('number_of_bath_room') ? 'is-invalid' : '' }}" type="text" name="number_of_bath_room" id="number_of_bath_room" value="{{ old('number_of_bath_room', $realEstateUnit->number_of_bath_room) }}">
            ...
            <div class="form-group">
                <label for="number_of_master_room">{{ trans('cruds.realEstateUnit.fields.number_of_master_room') }}</label>
                <input class="form-control {{ $errors->has('number_of_master_room') ? 'is-invalid' : '' }}" type="text" name="number_of_master_room" id="number_of_master_room" value="{{ old('number_of_master_room', $realEstateUnit->number_of_master_room) }}">
                @if($errors->has('number_of_master_room'))
                    <div class="invalid-feedback">
                        {{ $errors->first('number_of_master_room') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.realEstateUnit.fields.number_of_master_room_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="notes">{{ trans('cruds.realEstateUnit.fields.notes') }}</label>
                <input class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" type="text" name="notes" id="notes" value="{{ old('notes', $realEstateUnit->notes) }}">
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('has_garage') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="has_garage" id="has_garage" value="1" {{ $realEstateUnit->has_garage || old('has_garage', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="has_garage">{{ trans('cruds.realEstateUnit.fields.has_garage') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_garage') ? 'is-invalid' : '' }}" type="text" name="number_of_garage" id="number_of_garage" value="{{ old('number_of_garage', $realEstateUnit->number_of_garage) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('amenities') ? 'is-invalid' : '' }}" name="amenities[]" id="amenities" multiple>
                    @foreach($amenities as $id => $amenity)
                        <option value="{{ $id }}" {{ (in_array($id, old('amenities', [])) || $realEstateUnit->amenities->contains($id)) ? 'selected' : '' }}>{{ $amenity }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nears') ? 'is-invalid' : '' }}" name="nears[]" id="nears" multiple>
                    @foreach($nears as $id => $near)
                        <option value="{{ $id }}" {{ (in_array($id, old('nears', [])) || $realEstateUnit->nears->contains($id)) ? 'selected' : '' }}>{{ $near }}</option>
                    @endforeach
                </select>
                @if($errors->has('nears'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('features') ? 'is-invalid' : '' }}" name="features" id="features">{!! old('features', $realEstateUnit->features) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('purposes') ? 'is-invalid' : '' }}" name="purposes[]" id="purposes" multiple>
                    @foreach($purposes as $id => $purpose)
                        <option value="{{ $id }}" {{ (in_array($id, old('purposes', [])) || $realEstateUnit->purposes->contains($id)) ? 'selected' : '' }}>{{ $purpose }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('payments') ? 'is-invalid' : '' }}" name="payments[]" id="payments" multiple>
                    @foreach($payments as $id => $payment)
                        <option value="{{ $id }}" {{ (in_array($id, old('payments', [])) || $realEstateUnit->payments->contains($id)) ? 'selected' : '' }}>{{ $payment }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('types') ? 'is-invalid' : '' }}" name="types[]" id="types" multiple>
                    @foreach($types as $id => $type)
                        <option value="{{ $id }}" {{ (in_array($id, old('types', [])) || $realEstateUnit->types->contains($id)) ? 'selected' : '' }}>{{ $type }}</option>
                    @endforeach
                </select>
                @if($errors->has('types'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bua') ? 'is-invalid' : '' }}" type="text" name="bua" id="bua" value="{{ old('bua', $realEstateUnit->bua) }}">
                @if($errors->has('bua'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bua') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ror') ? 'is-invalid' : '' }}" type="text" name="ror" id="ror" value="{{ old('ror', $realEstateUnit->ror) }}">
                @if($errors->has('ror'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ror') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('roi') ? 'is-invalid' : '' }}" type="text" name="roi" id="roi" value="{{ old('roi', $realEstateUnit->roi) }}">
                @if($errors->has('roi'))
                    <div class="invalid-feedback">
                        {{ $errors->first('roi') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id">
                    @foreach($cities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $realEstateUnit->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.real-estate-units.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $realEstateUnit->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
