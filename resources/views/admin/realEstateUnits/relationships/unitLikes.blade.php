...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-unitLikes">
                <thead>
                    <tr>
                        <th width="10">
                            ...
                            <td>
                                ...
                                @can('like_delete')
                                    <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework"
                                        action="{{ route('admin.likes.destroy', $like->id) }}" method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-unitLikes:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
