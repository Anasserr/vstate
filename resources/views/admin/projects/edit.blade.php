    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="text" name="lat" id="lat" value="{{ old('lat', $project->lat) }}">
                @if($errors->has('lat'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lat') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lang') ? 'is-invalid' : '' }}" type="text" name="lang" id="lang" value="{{ old('lang', $project->lang) }}">
                @if($errors->has('lang'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lang') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('location_link') ? 'is-invalid' : '' }}" name="location_link" id="location_link">{{ old('location_link', $project->location_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('addresse') ? 'is-invalid' : '' }}" type="text" name="addresse" id="addresse" value="{{ old('addresse', $project->addresse) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nearbies') ? 'is-invalid' : '' }}" name="nearbies[]" id="nearbies" multiple>
                    @foreach($nearbies as $id => $nearby)
                        <option value="{{ $id }}" {{ (in_array($id, old('nearbies', [])) || $project->nearbies->contains($id)) ? 'selected' : '' }}>{{ $nearby }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Project::FEATURED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="featured_{{ $key }}" name="featured" value="{{ $key }}" {{ old('featured', $project->featured) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_type') ? 'is-invalid' : '' }}" name="project_type_id" id="project_type_id">
                    @foreach($project_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('project_type_id') ? old('project_type_id') : $project->project_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('plan_title') ? 'is-invalid' : '' }}" type="text" name="plan_title" id="plan_title" value="{{ old('plan_title', $project->plan_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('second_title') ? 'is-invalid' : '' }}" type="text" name="second_title" id="second_title" value="{{ old('second_title', $project->second_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('second_description') ? 'is-invalid' : '' }}" name="second_description" id="second_description">{!! old('second_description', $project->second_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('plan_description') ? 'is-invalid' : '' }}" type="text" name="plan_description" id="plan_description" value="{{ old('plan_description', $project->plan_description) }}">
