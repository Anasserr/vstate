...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-statusCompanies">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.company.fields.title_ar') }}
                        </th>
                        <th>
                            {{ trans('cruds.company.fields.title_en') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.companystatus.fields.title_en') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach ($companies as $key => $company)
                        <tr data-entry-id="{{ $company->id }}">
                            ...
                            <td>
                                @if ($company->image)
                                    <a href="{{ $company->image->getUrl() }}" target="_blank"
                            ...
                            <td>
                                {{ $company->status->title_ar ?? '' }}
                            </td>
                            <td>
                                {{ $company->status->title_en ?? '' }}
                            </td>
                            <td>
                                @can('company_show')
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-statusCompanies:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
