        ...
        <div class="card-body">
            <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('fb') ? 'is-invalid' : '' }}" type="text" name="fb"
                        id="fb" value="{{ old('fb', $setting->fb) }}">
                    @if ($errors->has('fb'))
                        <div class="invalid-feedback">
                            {{ $errors->first('fb') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('linkin') ? 'is-invalid' : '' }}" type="text"
                        name="linkin" id="linkin" value="{{ old('linkin', $setting->linkin) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('instgram') ? 'is-invalid' : '' }}" type="text"
                        name="instgram" id="instgram" value="{{ old('instgram', $setting->instgram) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('snap') ? 'is-invalid' : '' }}" type="text"
                        name="snap" id="snap" value="{{ old('snap', $setting->snap) }}">
                    @if ($errors->has('snap'))
                        <div class="invalid-feedback">
                            {{ $errors->first('snap') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('site_title') ? 'is-invalid' : '' }}" type="text"
                        name="site_title" id="site_title" value="{{ old('site_title', $setting->site_title) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text"
                        name="description" id="description" value="{{ old('description', $setting->description) }}">
